...
%  \begin{itemize}
%    \setlength\itemsep{.1em}
%    \item[--] {\sl Programming Languages:} TypeScript, C\#, T-SQL, JavaScript/HTML5/CSS3, Java, Python, C/C++, MIPS Assembly
%    \item[--] {\sl Software \& Tools:} Git, Node.js, React, Redux, Angular, Visual Studio, VS Code, .NET Framework, .NET Core,
%      SSMS, IIS
%      ModelSim, Quartus,
%      FidelisXPS, Qradar and Forensic Tool Kit
%    \item[--] {\sl AWS: Lambda, API Gateway, Kinesis Data Streams Kinesis Data Analytics, DynamoDB, AWS AppSync, OpenSearch, CloudFront, CloudWatch}
%    \item[--] {\sl Azure:} Azure Pipelines, Azure App Services, Azure SQL,
