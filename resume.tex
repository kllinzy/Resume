  ...
  {\sl Amazon: Full-Stack Software Development Engineer \hfill April 2022 - Present} 
    \begin{itemize}[leftmargin=*]
      ...
      \begin{itemize}
        ...
        \item Contributed to Golang-based edge service reading and processing industrial data from Programmable Logic Controllers (PLCs), deployed across 500+ Amazon sites on three distinct edge compute platforms and totaling over 1 million data points collected every second
        \item Built configuration management service for mapping data points and enabling self-service deployment of Amazon Machine Data Interface (AMDI) data models
        \item Shifted error detection left, catching at build time configuration errors that previously surfaced at runtime, making it impossible to deploy invalid data models to the service
        \item Designed the end-to-end data pipeline and owned deployment and DevOps for the service
        \item Led development of UI for monitoring Diesel health and status
      \end{itemize} \item[] Amazon Visualization Platform (AVP)
      \begin{itemize}
        \setlength\itemsep{.1em}
